...
class Mage_Catalog_Block_Product_List extends Mage_Catalog_Block_Product_Abstract
{
    ...
    public function getSizeProducts($product){
        $resource = Mage::getSingleton('core/resource');
        $readConnection = $resource->getConnection('core_read');

        $query="select taglia from " . $resource->getTableName("wsca_taglia_prodotti") . " where id='".$product->getId()."'";
        $stringaTaglia=$readConnection->fetchOne($query);

        $readConnection->closeConnection();

        return $stringaTaglia;
    }
    ...
    public function checkImgOver($_product) {
        $flag=false;
