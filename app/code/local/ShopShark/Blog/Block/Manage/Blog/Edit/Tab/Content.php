...
class ShopShark_Blog_Block_Manage_Blog_Edit_Tab_Content extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('post_image1', 'image', array(
            'name' => 'post_image1',
            'label' => Mage::helper('blog')->__('Immagine SX')
        ));


        $fieldset->addField('post_image2', 'image', array(
            'name' => 'post_image2',
            'label' => Mage::helper('blog')->__('Immagine CC')
        ));

        $fieldset->addField('post_image3', 'image', array(
            'name' => 'post_image3',
            'label' => Mage::helper('blog')->__('Immagine DX')
        ));

        $fieldset->addField('post_image4', 'image', array(
            'name' => 'post_image4',
            'label' => Mage::helper('blog')->__('Immagine Q1')
        ));

        $fieldset->addField('post_image5', 'image', array(
            'name' => 'post_image5',
            'label' => Mage::helper('blog')->__('Immagine Lunga')
        ));

        $fieldset->addField('post_image6', 'image', array(
            'name' => 'post_image6',
            'label' => Mage::helper('blog')->__('Immagine Q2')
        ));
        ...
        $fieldset->addField('post_content2', 'editor', array(
            'name' => 'post_content2',
            'label' => Mage::helper('blog')->__('Content 2'),
            'title' => Mage::helper('blog')->__('Content 2'),
            'config' => $config
        ));
