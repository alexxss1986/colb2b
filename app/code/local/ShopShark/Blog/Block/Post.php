...
class ShopShark_Blog_Block_Post extends ShopShark_Blog_Block_Abstract
{
    ...
    public function getProducts($postId)
    {
        ...
        $stringQuery = "select sku_prodotto,posizione from " . $resource->getTableName('articolo_prodotto') . " where id_articolo='" . $postId . "'";
        $arrayP = $readConnection->fetchAll($stringQuery);
