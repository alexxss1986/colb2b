...
class ShopShark_Blog_Model_Post extends Mage_Core_Model_Abstract {
    ...
    public function getPostImage1($width = false, $height = false) {

        $img = $this->getData('post_image1');
    ...
    public function getPostImage2($width = false, $height = false) {

        $img = $this->getData('post_image2');
    ...
    public function getPostImage3($width = false, $height = false) {

        $img = $this->getData('post_image3');
    ...
    public function getPostImage4($width = false, $height = false) {

        $img = $this->getData('post_image4');
    ...
    public function getPostImage5($width = false, $height = false) {

        $img = $this->getData('post_image5');
    ...
    public function getPostImage6($width = false, $height = false) {

        $img = $this->getData('post_image6');
