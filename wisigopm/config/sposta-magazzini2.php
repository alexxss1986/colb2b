...
if (isset($_SESSION['username'])) {
    if ($_SESSION['livello'] == 0 && $_SESSION['username']=='coltorti' ) {
        ...
        if ($flag==false){
            ...
            ?>
            <script type='text/javascript'>alert('<?php echo $errore ?>'); location.replace('../dettaglio-ordine-magazzino2.php?id=<?php echo $id_ordine ?>');</script>";
        ...
        echo "<script type='text/javascript'>alert('Creazione effettuata con successo!'); location.replace('../ordini-magazzino2.php');</script>";
    }
    else {
