...
<head>
    ...
    <title>Modifica Prodotto | Wisigo Product Management</title>
    ...
    <script type="text/javascript">
        ...
        function stopRKey(evt) {
            ...
            if ((evt.keyCode == 13) && (node.type=="text") && (node.id=="sku"))  { recuperaProdottiVisualizza(); return false;}
        }
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!-- Begin page heading -->
                <h1 class="page-heading">MODIFICA PRODOTTO<!--<small>Sub heading here</small>--></h1>
                ...
                <div class="the-box" style="float:left;width:100%">
                    ...
                    <form name="form_prodotto" method="post" action="visualizza-prodotto.php" onsubmit="return controlloFormModificaProdotto()">
                        <div id="form" style="width:100%">
                            <div class="form-group" style="float:left">
                                ...
                                <input type="text" name="sku" style="float:left;margin-left:50px;width:300px" class="form-control" placeholder="Id prodotto"  id="sku"
                                    ...
                                    ?>
                                    /> <button name="conferma" class="btn btn-success active" style="height: 35px;font-size: 15px;float:left;margin-left:30px"  type="button" onclick="recuperaProdottiVisualizza()"/>Conferma</button>
                            ...
                            <?php
                            // si entra nell'if quando dalla pagina di visualizzazione del prodotto si torna indietro alla pagina modifica
                            if (isset($_REQUEST['sku'])){
						...
						<div class=\"table-responsive\">";
                                ...
                                if ($id_prodotto!=""){
                                    ...
                                    if ($type_id=="configurable"){
                                        ...
                                        echo "<tr>
								<td align=left><input type='radio' name='check' value=\"$id_prodotto\" /></td>
								...
								<td align=left>$sku</td>
                                        ...
                                        foreach ( $ids as $id ) {
                                            $prodottoSemplice = Mage::getModel('catalog/product')->load($id);
                                            $sku=$prodottoSemplice->getSku();
                                            $nome=$prodottoSemplice->getName();

                                            echo "<tr>
									<td align=left><input type='radio' name='check' value=\"$id\" /></td>
									<td align=left>$nome</td>
									<td align=left>$sku</td>
									</tr>";
                                        }
