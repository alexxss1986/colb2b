        ...
        foreach ($orders as $order) {
            ...
            if (count($magazzinoArray) > 1) {
                ...
                echo "<td style=\"text-align:left\">" . $fromDate . "</td>";
                    ...
                    echo "<td style=\"text-align:left\"><span class=\"label label-warning\">Ordine da Consolidare</span>";



                echo "<td style=\"text-align:left\"><span class=\"label label-danger\">Ecommerce</span>";

                echo "<td style=\"text-align:left\"><a href=\"dettaglio-ordine-magazzino.php?id=$id_ordine\">Sposta magazzini</a></td>";
                ...
                echo "<td style=\"text-align:left\">" . $fromDate . "</td>";
                    ...
                    echo "<td style=\"text-align:left\">" . $cognomeSpedisci . " " . $nomeSpedisci . "</td>";
                    echo "<td style=\"text-align:left\"><span class=\"label label-success\">Ordine da Spedire</span>";
